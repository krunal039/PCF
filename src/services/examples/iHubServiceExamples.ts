...
export function exampleInitializeiHub(
...
export async function exampleFetchWithFilter(
  context: ComponentFramework.Context<any>
) {
  const service = exampleInitializeiHub(context);
...
export async function examplePostData(
  context: ComponentFramework.Context<any>
) {
  const service = exampleInitializeiHub(context);
...
export async function exampleUpdateData(
  ...
  const response = await service.updateData(
    `/api/pas/details/${recordId}`,
    data
  );
...
export async function exampleExecuteAction(
  context: ComponentFramework.Context<any>
) {
  const service = exampleInitializeiHub(context);
