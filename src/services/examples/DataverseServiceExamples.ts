...
export async function exampleFetchRecords(context: ComponentFramework.Context<any>) {
...
export async function exampleFetchSingleRecord(
    ...
    const account = await service.fetchRecord(
        'accounts',
        accountId,
...
export async function exampleCreateRecord(context: ComponentFramework.Context<any>) {
    const service = new DataverseService(context);
...
export async function exampleComplexQuery(context: ComponentFramework.Context<any>) {
    const service = new DataverseService(context);
