...
import { DataverseResponse, DataverseRecord, QueryOptions, CreateRecordOptions, UpdateRecordOptions } from '../models/DataverseModels';
...
export class DataverseService {
    ...
    async fetchRecord(
        ...
        try {
            this.logger.info(`Fetching record ${recordId} from entity: ${entityName}`);
    ...
    async deleteRecord(entityName: string, recordId: string): Promise<void> {
        try {
            this.logger.info(`Deleting record ${recordId} from entity: ${entityName}`);
